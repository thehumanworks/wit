...
// _worker.js
import wasmModule from "./8badd8744fc02309024c3ea9d2ac8c50e0477598-wit_snapshot.wasm";
var worker_default = {
  /**
  ...
  async fetch(request, env) {
    const apiResponse = await handleRequest(request, {
      loadWasmBytes: /* @__PURE__ */ __name(async () => wasmModule, "loadWasmBytes")
    });
...
// ../.wrangler/tmp/bundle-j4OroH/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-j4OroH/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.5476050338417711.mjs.map
